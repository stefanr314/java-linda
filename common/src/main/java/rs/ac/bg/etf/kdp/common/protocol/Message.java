...
public sealed interface Message extends Serializable
		permits Ack, BoolReply, Bye, Eval, Failure, FileChunk, Hello, In, Inp, JobAccepted, JobDispatch, JobFailed, JobFinished, JobRegistered, JobRejected, JobRunning, JobSubmitCommand, Out, Ping, Pong, Rd, Rdp, Registered, Reply, TupleReply {
}