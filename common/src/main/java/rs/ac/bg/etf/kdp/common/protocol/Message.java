...
public sealed interface Message extends Serializable
		permits Ack, BoolReply, Bye, Eval, Failure, FileChunk, Hello, In, Inp, InputFilesEnd, InputFilesStart, JobAccepted, JobDispatch, JobFailed, JobFinished, JobJarEnd, JobJarStart, JobRegistered, JobRejected, JobRunning, JobSubmitCommand, Out, Ping, Pong, Rd, Rdp, Registered, Reply, TupleReply {
}