...
public sealed interface Message extends Serializable
		permits Ack, BoolReply, Bye, Eval, Failure, Hello, In, Inp, JobAccepted, JobDispatch, JobRegistered, JobRejected, JobRunning, JobSubmitCommand, Out, Ping, Pong, Rd, Rdp, Registered, Reply, TupleReply {
}