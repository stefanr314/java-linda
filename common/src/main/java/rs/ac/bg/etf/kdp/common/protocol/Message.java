...
public sealed interface Message extends Serializable
		permits AbortResultTransfer, Ack, BoolReply, Bye, Eval, Failure, FileChunk, Hello, In, Inp, InputFilesEnd, InputFilesStart, JobAccepted, JobDispatch, JobFailed, JobFilesFailure, JobFinished, JobJarEnd, JobJarStart, JobNotPresent, JobRegistered, JobRejected, JobRunning, JobSubmitCommand, Out, OutputFilesEnd, Ping, Pong, Rd, Rdp, Registered, Reply, TupleReply {
}