...
public sealed interface Message extends Serializable
		permits Ack, BoolReply, Bye, Eval, Failure, FileChunk, FileChunkAck, Hello, In, Inp, InputFilesEnd, InputFilesStart, JobAccepted, JobDispatch, JobFailed, JobFilesFailure, JobFinished, JobJarEnd, JobJarStart, JobNotPresent, JobRegistered, JobRejected, JobRunning, JobSubmitCommand, Out, OutputFilesEnd, Ping, Pong, Rd, Rdp, Registered, Reply, TupleReply {
}